        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        plist.append('firstlast1212')
                                        plist.append('firstlast123321')
                                        plist.append('firstlast1111')
                                        plist.append('firstlast00')
                                        plist.append('firstlast0000')
                                        plist.append('firstlast4433')
                                        plist.append('firstlast123123')
                                        plist.append('firstlast12341234')
                                        plist.append('firstlast1122')
                                        plist.append('firstlast112233')
